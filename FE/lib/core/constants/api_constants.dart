class ApiConstants {
  ...
  static String communes(String provinceCode) => '/api/v1/geo/provinces/$provinceCode/communes';
  static String communesBoundaries(String provinceCode) => '/api/v1/geo/provinces/$provinceCode/communes-boundaries';
  static String communesPaginated(String provinceCode) => '/api/v1/geo/provinces/$provinceCode/communes-paginated';
  ...
  static String committeesByProvince(String provinceCode) => '/api/v1/geo/committees/$provinceCode';
